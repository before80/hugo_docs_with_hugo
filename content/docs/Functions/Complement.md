...
[https://gohugo.io/functions/complement/](https://gohugo.io/functions/complement/)
...
Although the example above demonstrates the `complement` function, you could use the [`where`](https://gohugo.io/functions/where/) function as well:
...
In this example we use the `complement` function to remove [stop words](https://en.wikipedia.org/wiki/Stop_word) from a sentence:
